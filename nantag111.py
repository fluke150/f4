...
cl = LINETCR.LINE()
cl.login(token='Et07JmjwKOIUg4Dp9hq3.lUhBwW+7E5ZqSTgYFtA9aW.xl8UMnm8LfEjx701G/YSHa5Vf7k/o2wOeLPlHjs7NIk=')
cl.loginResult()
...
╠➩〘Friendlist〙
╠═════════════════════════
║ ✯ SELFBOT PC MEDIA @2018 ✯
║  line.me/ti/p/~mazda99999
╚═════════════════════════
"""
#----------------------------------------------------------
botMessage ="""
...
╚═════════════════════════
"""
tjia="u2ee1db5b0ffb7b9cd0b2d1b27d36bd03"
#----------------------------------------------------------
setMessage ="""
╔═════════════════════════
║              ☆☞ S E T ☜☆
...
Bots=[mid,"u2ee1db5b0ffb7b9cd0b2d1b27d36bd03"]
Creator="u2ee1db5b0ffb7b9cd0b2d1b27d36bd03"
admin=["ud05301d1b3be2b18352bf461c8ce9fc2","ucb500cab7a260c6eeab0c30d84bba74d","ufd757bff32841c187161d3daaf077765"]
...
#------------------------[Welcome]----------------------------
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            cl.sendText(op.param1,"🇼 🇪 🇱 🇨 🇴 🇲 🇪\n" + cl.getContact(op.param2).displayName + "\nสวัสดีจ้า●﹏●\n " + str(ginfo.name) + " ☜" + "\n★ยินดีต้อนรับสมาชิกใหม่น้า\n★เข้ามาแล้วส่องเรทกันก่อนได้จ้า\n★มั่นใจค่อยลงก็ได้นะ\n★ท้าวบ้านนี้ชัวร์💯จ้า\nsᴇʟғʙᴏᴛ\n❥;ѕєʟғвот✿тαġαℓℓ\nʙч'❥;иαиич so goođ")
...
#--------------------------CEK SIDER------------------------------
            ...
            elif msg.text in ["Setview","Setpoint","."]:
                subprocess.Popen("echo '' > dataSeen/"+msg.to+".txt", shell=True, stdout=subprocess.PIPE)
                cl.sendText(msg.to, "☆Checkpoint Checked☆")
                print "Setview"

            elif msg.text in ["Viewseen","Check",".."]:
	        lurkGroup = ""
...
#--------------------------------------------------------
#Restart_Program
	    elif msg.text in ["รีบอท"]:
		if msg.from_ in Creator:
		    cl.sendText(msg.to, "บอทรีสตาร์ทแล้ว")
		    restart_program()
		    print "@Restart"
		else:
